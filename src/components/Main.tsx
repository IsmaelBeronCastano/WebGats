  ...
  return (
    <div className="container w-full h-full flex-row">
      ...
      <section>
        ...
        <div className= "sm:w-full md:w-2/4 md:mx-auto text-2xl text-center indie-flower border-8 border-purple-800 rounded-xl mt-4 mb-4">
          <a href="mailto:gatsdecatalunya699897@gmail.com">gatsdecatalunya699897@gmail.com</a></div>
